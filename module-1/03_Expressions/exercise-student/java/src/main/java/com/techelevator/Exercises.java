...
public class Exercises {
	...
	/*
	 ...
	 diff21(-10) → 31
	 */
	// if n equals or is less than 21 -> return n minus 21
	...
	/*
	 ...
	 posNeg(1, -1, false) → true //first line of code
	 posNeg(-1, 1, false) → true // second line of code
	 posNeg(-4, -5, true) → true // third line of code
	 */
	...
	// a = negative && b = positive && !negative
